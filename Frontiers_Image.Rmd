...
ggplot(city, aes(x=species, y=value, fill=species)) +
  geom_boxplot() + theme(axis.text.x = element_text(angle = 90), legend.position="none")
```
...
ggplot(cont, aes(x=species, y=value, fill=species)) +
